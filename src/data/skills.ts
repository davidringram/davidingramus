export const skills = [
  {
    ...
    description: "Full-Funnel Optimization, Digital Strategy, Brand Strategy, and Traditional Marketing.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 17l-5-5 5-5v3l-2 2 2 2v3zm8-10l5 5-5 5v-3l2-2-2-2V7z"/></svg>`,
    title: "Marketing Operations",
    description: "Database & CRM, MarTech, Conversion Rate Optimization, Automation, and AI.",
  },
  {
    ...
    description: "Reports & Dashboard, Forecasting, Market Research, Data Analysis, Marketing Reserach.",
  },
  {
  ...
  },
  {
    ...
    title: "Management",
    description: "Leadership, Team Management, Project Management, Economics, and Business Strategy.",
  },
];
