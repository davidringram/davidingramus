# ⚡ David R. Ingram | Fractional CMO & MarTech Architect

**Strategic Marketing | Combat Veteran | Technical Execution**

Bridging the gap between high-level brand strategy and full-stack technical marketing. I apply military precision, asymmetric tactics, and data-driven insights to scale brands and optimize digital infrastructure.
...
### 📡 Mission Logs & Thought Leadership

I write about the intersection of military tactics and marketing strategy at [davidingram.us](https://davidingram.us).
...
- **Brand Strategy:** Brand Positioning, Brand Management, Brand Messaging, and Brand Voice.
- **Conversion Optimization:** Landing Pages, Funnel Design, A/B Testing, Astro/Tailwind/Alpine, and CI/CD.
- **Behavioral Economics:** Consumer Psychology, Consumer Behavior, and Consumer Decision Making.
- **Management:** Leadership, Team Management, Project Management, Economics, and Strategy.
...
- **[marketing-dashboard](https://github.com/davidringram/dimc-dashboard-template):** Custom marketing dashboards build for local service businesses created with Astro, Supabase, and n8n.
- **[marketing-tools-hub](https://github.com/davidringram/marketing-tools-hub):** An Astro-powered centralized platform for technical marketing resources.
- **[Metalomics, Podcast](https://metalomicspodcast.com/):** A podcast about economics, where we also talk policy, politics, current events, and metal music.

---

### 📞 Contact for Briefing

- **Web:** [davidingram.us](https://davidingram.us)
- **LinkedIn:** [https://www.linkedin.com/in/davidingrammkt/](#)
- **Email:** [Contact Page](https://davidingram.us/contact)
